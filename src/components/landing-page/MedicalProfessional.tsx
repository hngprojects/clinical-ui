        ...
        lg:justify-between relative z-10">
          ...
          <div className="flex flex-[1.2] flex-col items-start gap-6 lg:gap-8 text-left">
            ...
            <div className="flex flex-col gap-4">
              <h2 className="max-w-2xl text-[28px] lg:text-[40px] font-bold leading-[1.3] 
              ...
              <p className="max-w-2xl text-[16px] lg:text-[18px] font-normal 
            ...
            <Button className="w-fit h-[42px] lg:h-[48px] rounded-[12px] 
