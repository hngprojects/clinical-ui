            ...
            <div className="relative h-[320px] w-[320px] lg:h-[600px] lg:w-[600px] flex items-center justify-center scale-90 sm:scale-100 lg:scale-100 translate-x-6 lg:translate-x-0">
              ...
              <div className="relative flex flex-col items-center gap-0 z-10 w-full max-w-[240px] lg:max-w-[380px]">
                ...
                <div className="relative z-10 w-full">
                  ...
                  <div className="rounded-t-[16px] lg:rounded-t-[24px] border-x border-t border-brand-blue bg-gradient-to-b from-white via-white to-transparent p-4 lg:p-8 pb-8 lg:pb-12 flex flex-col g
                    ...
                    <div className="flex items-center gap-4 rounded-[16px] bg-[#FFFFFE33] pt-2 pr-2 pb-3 pl-2 h-[60px] border-b-2 border-[#1B1B1B14] text-[#F59E0B] w-full max-w-[352px]">
                      <Image
                        ...
                        height={24}
                      />
                      <span className="text-[8px] lg:text-[12px] font-bold uppercase tracking-[0.2em]">
                        Key Findings
                      </span>
                    </div>

                    {/* Recommendations inside the fading container flow */}
                    <div className="flex items-center gap-4 rounded-[16px] bg-[#FFFFFE33] pt-2 pr-2 pb-3 pl-2 h-[60px] border-b-2 border-[#1B1B1B14] text-emerald-500 w-full max-w-[352px]">
                      <Image
                ...
                <div className="z-20 mt-2 lg:mt-4 w-full">
                  <Button
                    variant="brand"
                    className="w-full rounded-lg lg:rounded-xl py-4 lg:py-7 text-[10px] lg:text-sm font-bold shadow-lg transition-all bg-[#1565C0] text-white hover:bg-[#1565C0]/90"
                  >
                    Get Started
