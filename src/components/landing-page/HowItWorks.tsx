...
const STEPS = [
  {
    ...
    image: '/assets/landing-page-assets/image1-mobile.jpg',
  },
  {
    number: 2,
    ...
    image: '/assets/landing-page-assets/image2-mobile.jpg',
  },
  {
    number: 3,
    ...
    image: '/assets/landing-page-assets/image3-mobile.jpg',
  },
  {
    number: 4,
    ...
    image: '/assets/landing-page-assets/image4-mobile.jpg',
  },
];
      ...
      <div className="container mx-auto px-6 lg:px-12">
        ...
        <div className="hidden lg:flex gap-8 items-stretch">
          ...
          <div className="flex flex-col gap-8 flex-1">
            ...
            <div className="flex gap-8">
              ...
              >
                <div className="relative w-full h-full rounded-[16px] overflow-hidden">
                  <Image
                    src="/assets/landing-page-assets/image2-mobile.jpg"
                    alt="AI analysis"
                    fill
                    className="object-cover"
                  />
              ...
              >
                <div className="relative w-full h-full rounded-[16px] overflow-hidden">
                  <Image
                    src="/assets/landing-page-assets/image3-mobile.jpg"
            ...
            >
              <Image
                src="/assets/landing-page-assets/image4-desktop.jpg"
