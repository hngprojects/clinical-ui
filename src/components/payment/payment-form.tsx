...
export function PaymentForm({ amount = 5000, onSubmit }: PaymentFormProps) {
  ...
  return (
    <div className="w-full max-w-[480px] rounded-2xl border border-gray-200 bg-white px-8 py-8 shadow-sm">
      ...
      {method === 'transfer' && (
        <div className="flex flex-col gap-4">
          <div className="rounded-lg bg-gray-50 p-4 text-sm text-gray-600">
            ...
            <p>
              Amount: <span className="font-medium text-gray-900">₦{amount.toLocaleString()}</span>
            </p>
          </div>
          <button
            onClick={onSubmit}
