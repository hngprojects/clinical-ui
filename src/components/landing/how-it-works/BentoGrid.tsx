    ...
    <section className="bg-[#FAFAFA] py-24 overflow-hidden">
      <div className="container mx-auto px-6 lg:px-12">
        ...
        >
          ...
          >
            ...
            <div className="p-8 flex flex-col gap-4">
              <div className="flex items-center gap-3">
                <Image src="/assets/how-it-works/mynaui_one-waves-solid.svg" alt="1" width={36} height={36} />
          ...
          <motion.div variants={itemVariants} className="bg-white rounded-3xl border border-[#1B1B1B14] shadow-sm overflow-hidden flex flex-col">
              ...
              <div className="w-full h-full bg-white rounded-t-2xl border-t-2 border-l-2 border-r-2 border-[#1565C0] p-5 relative shadow-[0px_-6px_16px_rgba(0,0,0,0.06)] overflow-hidden">
                <div className="flex flex-col gap-4">
                  <div className="flex items-center gap-2">
                    ...
                    >
                      <Image src="/assets/how-it-works/ai-scan.svg" alt="AI" width={20} height={20} />
                    </motion.div>
                  ...
                  <div className="relative w-max">
                    <div className="bg-[#FEF9E6] rounded-xl px-3 py-2 flex items-center gap-2 border-b border-[#E5E7EB] shadow-sm">
                      <div className="p-1.5 bg-[#F59E0B] rounded-lg">
                        <Image src="/assets/how-it-works/note.svg" alt="Note" width={16} height={16} className="invert brightness-200" />
                      </div>
                      <span className="text-[#F59E0B] text-sm font-semibold pr-3">Analyze Lab Result</span>
                    </div>
                    <motion.div 
                    ...
                    >
                      <Image src="/assets/how-it-works/Vector.svg" alt="Cursor" width={36} height={36} className="object-contain" />
                    </motion.div>
                  </div>

                  <div className="space-y-3 pt-2">
                    {[0.9, 0.7, 0.5].map((w, i) => (
                      <div key={i} className="w-full h-3 bg-[#F1F5F9] rounded-full overflow-hidden relative">
                         <motion.div 
                          initial={{ x: "-100%" }}
                          animate={{ x: "100%" }}
            ...
            <div className="p-6 flex flex-col gap-2">
              <div className="flex items-center gap-3">
                <Image src="/assets/how-it-works/mynaui_two-waves-solid.svg" alt="2" width={32} height={32} />
                <h3 className="text-lg font-bold text-[#1B1B1B]">AI analyzes your data</h3>
              </div>
              <p className="text-[#5E5E5E] text-sm leading-relaxed">Our system extracts and interprets your lab values instantly.</p>
            </div>
          </motion.div>

          <motion.div variants={itemVariants} className="bg-white rounded-3xl border border-[#1B1B1B14] shadow-sm overflow-hidden flex flex-col group">
            ...
            <div className="p-6 flex flex-col gap-2">
              <div className="flex items-center gap-3">
                <Image src="/assets/how-it-works/mynaui_three-waves-solid.svg" alt="3" width={32} height={32} />
                <h3 className="text-lg font-bold text-[#1B1B1B]">Get clear explanations</h3>
              </div>
              <p className="text-[#5E5E5E] text-sm leading-relaxed">See a simple, structured breakdown of what your results mean.</p>
            </div>
          </motion.div>

          <motion.div variants={itemVariants} className="md:col-span-2 relative flex flex-col md:block rounded-3xl overflow-hidden border border-[#1B1B1B14] bg-white md:bg-transparent md:h-72 group">
            ...
            <div className="md:hidden p-4">
              <div className="relative h-48 w-full rounded-2xl overflow-hidden bg-[#F1F5F9]">
                <Image src="/assets/how-it-works/Rectangle 34624423.png" alt="Mobile" fill className="object-cover" />
              </div>
            </div>
